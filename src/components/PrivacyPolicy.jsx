  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-8 shadow-lg">
      ...
      <section className="mb-8">
        ...
        <h3 className="text-xl font-semibold mb-2 mt-4 ">Other Data</h3>
        <p className="mb-4">
      ...
      <section>
        ...
        <p className="mb-4">
          If you are located outside the Federal Republic of Nigeria and choose
          to provide information to us, please note that we transfer the data,
          including Personal Data, to the Federal Republic of Nigeria and
          process it there.
        </p>
        <p className="mb-4">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li className="mb-2">
            ...
            <ul className="list-decimal pl-6">
              <li className="mb-1">to our subsidiaries and affiliates;</li>
              <li className="mb-1">
              ...
              <li className="mb-1">with your consent in any other cases;</li>
              <li className="mb-1">
      ...
      <section class="py-8 px-6 bg-gray-50" id="caloppa">
        ...
        <ul class="list-disc ml-8 mb-4">
          <li class="mb-2">Users can visit our site anonymously.</li>
          <li class="mb-2">
        ...
        <p class="mb-4">Our Policy on “Do Not Track” Signals:</p>
      ...
      <section class="py-8 px-6 bg-gray-50" id="ccpa">
        <h2 class="text-2xl font-bold mb-4 text-gray-800">
        ...
        <p class="mb-4">
          <strong>1. What personal information we have about you:</strong> If
        ...
        <p class="mb-4">
          <strong>2. To delete your personal information:</strong> If you make
        ...
        <p class="mb-4">
          <strong>3. To stop selling your personal information:</strong> We
        ...
        <p class="mb-4">
          ...
          your personal information to function. But in no circumstances will we
