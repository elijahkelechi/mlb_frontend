      ...
      <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="space-y-4 md:space-x-4">
          ...
          <section class="py-8" id="subscriptions">
            ...
            <p class="mb-4">
              Should automatic billing fail to occur for any reason, Multi Level
              Boost reserves the right to terminate your access to the Service
          ...
          <section class="py-8" id="content">
            ...
            <p class="mb-4">
              Content found on or through this Service are the property of Multi
              Level Boost or used with permission. You may not distribute,
          ...
          <section class="py-8" id="governing-law">
            ...
            <p class="mb-4">
              ...
              laws of the Federal Republic of Nigeria, which governing law
              applies to the agreement without regard to its conflict of law
              provisions.
            </p>
