      ...
      <div className="container mx-auto py-12 md:px-8 px-2">
        ...
        >
          ...
          <p className="text-gray-700 mb-4">
            Stop wasting money 💸 on ads that don’t convert! Let us help you run
            highly converting Facebook Ads. Whether you’re a startup or an
            established business, we create customized campaigns that reach your
            ideal audience and drive real results.
          </p>
