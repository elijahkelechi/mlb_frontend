      ...
      <div className="bg-white bg-opacity-90 p-6 md:p-16 rounded shadow-lg w-full">
        ...
        <div className="bg-gray-100 p-8 rounded-lg shadow-md mt-12">
          ...
          <ul className="list-disc ml-6 text-gray-700 mb-6">
            <li>
              <strong>Basic Plan:</strong> ₦30,000 for the entire month (Billed
              Monthly)
            </li>
            <li>
              <strong>Standard Plan:</strong> ₦50,000 for the entire month
              (Billed Monthly)
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 text-gray-700 mb-6">
            <li>
              For the <strong>Basic Plan</strong>, you’ll pay us ₦30,000 for our
              services.
            </li>
            <li>
