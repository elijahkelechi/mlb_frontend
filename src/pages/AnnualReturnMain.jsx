  ...
  return (
    ...
    >
      <div className="w-full pt-16 mx-auto bg-gray-50 bg-opacity-70 md:px-8 px-6 md:p-16">
        ...
        <h2 className="text-4xl font-semibold mb-6 flex items-center justify-center space-x-3">
        ...
        <p className="text-lg mb-6">
          1. Select your registration type below to proceed to the filling page,
          or
